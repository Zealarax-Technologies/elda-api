...
async function UpdatePartnerCategoryRequest(req, res, next)
{
    ...
    if(await models.PartnerCategory.findOne({where: {name: value?.name, uuid: {[Op.ne]: req.params.id}}}))
    {
...
module.exports = UpdatePartnerCategoryRequest;