...
async function CreateContactDetailsRequest(req, res, next)
{
    ...
    const [existingTitle] = await Promise.all([
        models.ContactDetails.findOne({ where: { title: value.title } }),
    ]);
...
module.exports = CreateContactDetailsRequest;