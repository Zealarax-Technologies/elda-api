...
async function CreatePositionCategoryRequest(req, res, next)
{
    ...
    if(await models.PositionCategory.findOne({where: {name: value.name}}))
    {
...
module.exports = CreatePositionCategoryRequest;